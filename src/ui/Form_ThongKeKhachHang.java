...
public class Form_ThongKeKhachHang extends JPanel {
	...
	public Form_ThongKeKhachHang() {
		...
		jPanel_North.add(jLabel_Title = new JLabel("THỐNG KÊ KHÁCH HÀNG"));
		...
		// Table sản phẩm
		String[] columnsHoaDon = { "Mã Khách Hàng", "Tên Khách Hàng", "Tổng Thanh Toán" };
		...
		box4.add(jLabel_Title2 = new JLabel("Khách Hàng Mua Nhiều Theo Tổng Thanh Toán"));
	...
	private void docDuLieuKhachHangTop() {
		ArrayList<HoaDon> dsHoaDon = kh_Dao.getKhachHangTop();
		modelTableTKDoanhThu.setRowCount(0);
		for (HoaDon hd : dsHoaDon) {
			Object[] row = { hd.getKhachHang().getMaKH(), hd.getKhachHang().getTenKH(), hd.getTongThanhToan() };
